...
public class Bluetooth extends AppCompatActivity {
        ...
        public void run() {
            try {
                if (!BluetoothService.BluetoothConnectionStatus) {
                    ...
                    Toast.makeText(Bluetooth.this, "Successfully Reconnected", Toast.LENGTH_SHORT).show();
                }
                ...
                e.printStackTrace();
                Toast.makeText(Bluetooth.this, "Reconnection Failed! Re-attempting in 5 seconds", Toast.LENGTH_SHORT)
                        .show();
            }
        }
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        otherDevicesListView = findViewById(R.id.devicesFoundListView);
        ...
        Button scanButton = this.findViewById(R.id.scanBtn);
        ...
        bluetoothSwitch.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton compoundButton, boolean isChecked) {
                ...
                if (myBluetoothAdapter == null) {
                    Log.d(TAG, "Bluetooth not supported by device!");
                    Toast.makeText(Bluetooth.this, "Bluetooth not supported by device!", Toast.LENGTH_LONG)
                            .show();
        ...
        connStatusTextView = findViewById(R.id.connectionStatus);
    ...
    private final BroadcastReceiver scannerWatcher = new BroadcastReceiver() {
        @SuppressLint("MissingPermission")
        @Override
        public void onReceive(Context context, Intent intent) {
    ...
    private final BroadcastReceiver pairingWatcher = new BroadcastReceiver() {
        @SuppressLint("MissingPermission")
        @Override
        public void onReceive(Context context, Intent intent) {
            final String action = intent.getAction();
    ...
    private final BroadcastReceiver connectionWatcher = new BroadcastReceiver() {
        @SuppressLint("MissingPermission")
        @Override
        public void onReceive(Context context, Intent intent) {
