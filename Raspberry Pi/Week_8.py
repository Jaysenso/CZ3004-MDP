...
class RaspberryPi:
    ...
    def command_follower(self) -> None:
        ...
        while True:
            ...
            # Snap command
                ...
                print("SNAP COMMAND DETECTED , putting SNAP command on RPI Queue")
    ...
    # def snap_and_recv(self, obstacle_id_with_signal: str) -> None:
    #     """
            ...
            try:
                with open(filename, 'rb') as file:
                    ...
                    if response.status_code == 200:
                        ...
                        # retry if no symbol detected/unreognised
#                         if results['image_id'] == 'NA' or retry_count > 2:
#                             self.logger.info("Undetected, moving on")
#                             self.movement_lock.release() #THIS IS ADDED, REMOVE NXT TIME
#                             break
#                         else:
...
#                             self.movement_lock.release() #THIS IS ADDED, REMOVE NXT TIME
                        ...
                        #self.android_queue.put(AndroidMessage("cat": image-rec, "value": {"image_id": image_id_value, "obstacle_id": obstacle_id}))
                        self.movement_lock.release()
                        self.android_queue.put(AndroidMessage("image-rec", results))
    ...
    def request_algo(self, data, robot_x=1, robot_y=1, robot_dir=0, retrying=False):
        ...
        self.android_queue.put(AndroidMessage("info",result))
