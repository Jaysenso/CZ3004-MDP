...
class RaspberryPi:
    ...
    def snap_and_rec(self, obstacle_id_with_signal):
        """
        ...
        self.logger.info("Capturing image for obstacle id:" +  obstacle_id)
        # self.android_queue.put(AndroidMessage(
...
if __name__ == "__main__":
    ...
    # action: PiAction = self.rpi_action_queue.get()
    snap_and_rec(obstacle_id_with_signal=PiAction(cat="snap", value=obstacle_id_with_signal).value)